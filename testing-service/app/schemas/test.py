...
# Enum типов личности (должен совпадать с testing-service)
...
# Enum статусов теста (должен совпадать с testing-service)
...
# Enum типов вопросов (должен совпадать с testing-service)
